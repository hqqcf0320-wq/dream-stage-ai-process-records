...
OUTPUT = ROOT / "output" / "pdf" / "stage_mixed_reality_deep_research_zh.pdf"
...
def header_footer(canvas, doc):
    ...
    if doc.page > 1:
        ...
        canvas.drawString(18 * mm, height - 11 * mm, "当代舞台虚实结合深度调研")
...
def build() -> None:
    ...
    doc = ReportDoc(
        ...
        subject="舞台戏剧、混合现实、现场影像、动作捕捉与 White Hole",
    )
